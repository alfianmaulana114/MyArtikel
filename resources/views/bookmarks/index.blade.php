                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        <div class="rounded-xl border theme-border-primary bg-[color:var(--surface-primary)] p-4">
                            ...
                            <div class="mt-1 text-lg font-semibold theme-text-primary" id="total-bookmarks">{{ auth()->user()->bookmarks_count ?? 0 }}</div>
                        </div>
                        <div class="rounded-xl border theme-border-primary bg-[color:var(--surface-primary)] p-4">
                        ...
                        <div class="rounded-xl border theme-border-primary bg-[color:var(--surface-primary)] p-4">
                            ...
                            <div class="mt-1 text-lg font-semibold theme-text-primary" id="total-categories">{{ auth()->user()->bookmark_categories_count ?? 0 }}</div>
                        </div>
                    </div>
                </div>
            </div>
