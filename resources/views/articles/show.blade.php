                    ...
                    <div class="flex items-start justify-between gap-3 mb-6">
                        <div>
                            ...
                            <p class="text-sm theme-text-muted mt-1">
                                ...
                                @if ($article->research_context)
                                    <span class="text-[#AA5F3C] font-medium">untuk konteks: {{ $article->research_context }}</span>
                                @elseif ($article->research_title)
                                    untuk penelitian: <span class="text-[#AA5F3C] font-medium">{{ $article->research_title }}</span>
                                @endif
                            </p>
                        </div>
                            ...
                            @foreach ($article->ai_quotation_suggestions as $index => $citation)
                                <div class="rounded-xl border theme-border-primary bg-[color:var(--surface-primary)] p-5 hover:shadow-md transition-shadow">
                                    ...
                                    <div class="mb-3 space-y-3">
                                        ...
                                        @else
                                            <div class="paraphrase-action" data-index="{{ $index }}">
                    ...
                    @else
                        <div class="rounded-xl border theme-border-primary bg-[color:var(--surface-primary)] p-8 text-center">
                            ...
                            <div class="mt-2 text-xs theme-text-muted">
                                ...
                                @else
                                    Klik tombol <strong>Buat Kutipan</strong> di atas untuk membuat saran kutipan yang relevan dengan <strong>{{ $article->research_title }}</strong>.
                                @endif
                            </div>
                        </div>
                    @endif
