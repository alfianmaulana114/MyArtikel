...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-4" x-data="projectStats()">
                <div class="card rounded-xl p-5">
                    <div class="flex items-center gap-4">
                        <div class="p-3 rounded-xl bg-[#AA5F3C]/10">
                        ...
                        <div>
                            ...
                            <div class="text-sm theme-text-muted">Total Project</div>
                        </div>
                    </div>
                </div>
                <div class="card rounded-xl p-5">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-sm theme-text-muted">Drafting</div>
                        </div>
                    </div>
                </div>
                <div class="card rounded-xl p-5 hidden lg:block">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-sm theme-text-muted">Completed</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card rounded-xl p-5">
                <div class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    ...
                    <div class="sm:w-48">
                        <label for="projects-status" class="block text-sm font-medium theme-text-secondary mb-1.5">Status</label>
                        <select
                            id="projects-status"
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            (() => {
                ...
                const initialPaginator = <?php echo json_encode($projects, 15, 512) ?>;
                const initialItems = initialPaginator?.data ?? [];
                setEmpty(initialItems.length === 0);
                renderProjects(initialItems);
                renderPagination({
                    current_page: initialPaginator?.current_page,
                    last_page: initialPaginator?.last_page,
                });
                ...
                if (window.Alpine) {
                    const statsComponent = document.querySelector('[x-data="projectStats()"]');
                    if (statsComponent && statsComponent.__x) {
                        statsComponent.__x.$data.updateStats(initialItems);
                    }
                }
