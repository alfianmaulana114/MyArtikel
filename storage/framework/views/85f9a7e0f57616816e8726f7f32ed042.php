<div class="bookmark-button-wrapper" data-controller="bookmark">
    <button type="button"
            class="<?php echo e($getButtonClasses()); ?>"
            data-action="click->bookmark#toggle"
            data-bookmark-target="button"
            title="<?php echo e($getTooltipText()); ?>"
            <?php $__currentLoopData = $getDataAttributes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                data-<?php echo e($key); ?>="<?php echo e($value); ?>"
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>>
        
        <svg class="<?php echo e($getIconClasses()); ?> mr-1.5" 
             data-bookmark-target="icon"
             fill="<?php echo e($isBookmarked ? 'currentColor' : 'none'); ?>" 
             stroke="currentColor" 
             viewBox="0 0 24 24">
        ...
        <span data-bookmark-target="text"><?php echo e($getButtonText()); ?></span>
    </button>

    <?php if($showCategories && auth()->check() && $categories->isNotEmpty()): ?>
                    ...
                    <select data-bookmark-target="categorySelect"
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category->id); ?>" 
                                    <?php echo e($bookmark && $bookmark->category_id === $category->id ? 'selected' : ''); ?>

                                    style="color: <?php echo e($category->formatted_color); ?>">
                ...
                <?php if($bookmark): ?>
                    <div class="space-y-2 pt-2 border-t border-gray-200">
                        ...
                        <button type="button"
                                ...
                                class="w-full text-left px-3 py-2 text-sm <?php echo e($bookmark->is_favorite ? 'text-yellow-600' : 'text-gray-700'); ?> hover:bg-gray-100 rounded-md">
                            <svg class="w-4 h-4 inline mr-2" fill="<?php echo e($bookmark->is_favorite ? 'currentColor' : 'none'); ?>" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path>
                            </svg>
                            <?php echo e($bookmark->is_favorite ? 'Remove from favorites' : 'Add to favorites'); ?>
                        ...
                        <button type="button"
                            ...
                            <?php echo e($bookmark->is_archived ? 'Unarchive' : 'Archive'); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\laragon\www\myartikel\resources\views\components\bookmark-button.blade.php ENDPATH**/ ?>