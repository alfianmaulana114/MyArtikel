...
<?php endif; ?>
    ...
    <?php else: ?>
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-4 space-y-1">
            ...
            <a
                href="<?php echo e(route('summaries.page')); ?>"
                class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('summaries.*') ? $linkActive : $linkIdle); ?>"
            >
                <svg class="<?php echo e($iconBase); ?>" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            <a
                href="<?php echo e(route('pdf.export.form')); ?>"
                class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('pdf.export.*') ? $linkActive : $linkIdle); ?>"
            >
                <svg class="<?php echo e($iconBase); ?>" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            <a
                href="<?php echo e(route('pdf.history')); ?>"
                class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('pdf.history') ? $linkActive : $linkIdle); ?>"
            >
                <svg class="<?php echo e($iconBase); ?>" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            <a
                href="<?php echo e(route('jobs.monitoring')); ?>"
                class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('jobs.*') ? $linkActive : $linkIdle); ?>"
            >
                <svg class="<?php echo e($iconBase); ?>" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2a2 2 0 012-2h2a2 2 0 012 2v2m-7 0h8m-8 0a2 2 0 01-2-2V7a2 2 0 012-2h8a2 2 0 012 2v8a2 2 0 01-2 2" />
                </svg>
