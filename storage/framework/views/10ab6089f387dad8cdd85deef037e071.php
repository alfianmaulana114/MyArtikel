            ...
            <?php if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail()): ?>
                <div>
                    <p class="text-sm mt-2 theme-text-secondary">
                        ...
                        <button form="send-verification" class="underline text-sm theme-text-muted hover:opacity-90 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#AA5F3C]">
                    ...
                    <?php if(session('status') === 'verification-link-sent'): ?>
                        <p class="mt-2 font-medium text-sm text-[color:var(--success)]">
...
<?php /**PATH C:\laragon\www\myartikel\resources\views\profile\partials\update-profile-information-form.blade.php ENDPATH**/ ?>