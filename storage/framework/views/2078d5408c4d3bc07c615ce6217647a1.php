...
<?php endif; ?>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md theme-text-secondary hover:opacity-90 focus:outline-none transition duration-150 ease-in-out">
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t theme-border-primary">
            <div class="px-4">
                <div class="font-medium text-base theme-text-primary"><?php echo e(Auth::user()->name); ?></div>
                <div class="font-medium text-sm theme-text-muted"><?php echo e(Auth::user()->email); ?></div>
            </div>
...
<?php /**PATH C:\laragon\www\myartikel\resources\views\layouts\navigation.blade.php ENDPATH**/ ?>