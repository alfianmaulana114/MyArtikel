                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center gap-4">
                        <div class="flex items-center gap-3 flex-1">
                            <span class="text-xs px-3 py-1.5 rounded-full
                                <?php if($project->status === 'drafting'): ?> bg-yellow-500/10 text-yellow-600 dark:text-yellow-400
                                <?php elseif($project->status === 'reviewing'): ?> bg-purple-500/10 text-purple-600 dark:text-purple-400
                                <?php else: ?> bg-green-500/10 text-green-600 dark:text-green-400
                                <?php endif; ?>">
                    ...
                    <div class="space-y-6 max-w-2xl">
                        ...
                        <div>
                            ...
                            <select id="edit-project-status" class="block w-full rounded-lg shadow-sm border theme-border-primary bg-[color:var(--surface-primary)] text-[color:var(--text-primary)] focus:border-[#AA5F3C] focus:ring-[#AA5F3C]">
                                <option value="drafting" <?php echo e($project->status === 'drafting' ? 'selected' : ''); ?>>Drafting</option>
                                <option value="reviewing" <?php echo e($project->status === 'reviewing' ? 'selected' : ''); ?>>Reviewing</option>
