...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('logout')); ?>">
            ...
            <button type="submit" class="underline text-sm theme-text-secondary hover:text-[color:var(--text-link-hover)] rounded-md focus:outline-none focus:ring-2 focus:ring-[#AA5F3C]">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\myartikel\resources\views\auth\verify-email.blade.php ENDPATH**/ ?>