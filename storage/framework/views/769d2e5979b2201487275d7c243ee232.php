...
<?php $component->withAttributes([]); ?>
        ...
        <div class="flex items-center justify-between gap-3">
            <div class="min-w-0 flex-1">
                <h2 class="font-semibold text-xl theme-text-primary leading-tight truncate">
                    Peta Pengetahuan: <?php echo e($project->title); ?>
            ...
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('projects.show', $project)); ?>" class="btn btn-secondary text-sm">
    ...
    <script src="<?php echo e(asset('js/cytoscape.min.js')); ?>"></script>
            ...
            if (!data.nodes || data.nodes.length === 0) {
                loading.innerHTML = `
                    <div class="text-center">
                        ...
                        <a href="<?php echo e(route('projects.show', $project)); ?>" class="mt-3 inline-flex text-xs text-[#AA5F3C] hover:underline">Tambahkan artikel &rarr;</a>
                    </div>
                `;
                return;
            }
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\myartikel\resources\views\projects\graph.blade.php ENDPATH**/ ?>